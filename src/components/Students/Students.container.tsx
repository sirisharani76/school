...
import { deleteStudentById, fetchStudentData, fetchStudentDataAsync, fetchStudentDataAxios } from "./Student.service";
import Students from "./Students";
import { IStudent, IStudents } from "./Students.reducer";

const StudentsContainer = () => {
  const [students, setStudents] = useState<IStudent[]>([
    { id: "101", name: "Laxmi", age: 24, marks: 45 },
  ...
  return (
    <>
      <Students students={students} onDeleteStudent={onDeleteStudent} ></Students>
    </>
  );
};
